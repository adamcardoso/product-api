package com.adam.backend.productapi.exceptions.advice;

import com.adam.backend.productapi.dtos.ErrorDTO;
...
@ControllerAdvice(basePackages = "com.adam.backend.productapi.api")
